...
OPERATION_SPECS: tuple[OperationSpec, ...] = (
    ...
    OperationSpec(
        ...
        description="Reconcile a commit-capable operation by idempotency key or operation ID and receive retry guidance.",
        roles=("curator",),
        discovery_surfaces=frozenset({STANDARD_SURFACE, CURATOR_SURFACE, ADMIN_SURFACE}),
    ),
    OperationSpec(
...
WORKFLOW_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "curate": {
        "description": "Inspect, revise, review, apply, and reconcile proposals; use direct mutations only in admin mode.",
        "operations": [
            "proposal_list",
            "proposal_get",
            "proposal_asset_get",
