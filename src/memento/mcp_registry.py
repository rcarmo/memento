...
OPERATION_SPECS: tuple[OperationSpec, ...] = (
    ...
    OperationSpec(
        op_name="skill_search",
        tool_name="memory_skill_search",
        method_name="memory_skill_search",
    ...
    OperationSpec(
        ...
        description="Submit a skill pack proposal with Markdown and bundled assets.",
        roles=("proposer",),
        discovery_surfaces=frozenset({STANDARD_SURFACE, ADMIN_SURFACE}),
    ),
    OperationSpec(
        op_name="skill_proposal_get",
        tool_name="memory_skill_proposal_get",
        method_name="memory_skill_proposal_get",
        description="Read one skill pack proposal record.",
        roles=("proposer",),
        discovery_surfaces=frozenset({STANDARD_SURFACE, CURATOR_SURFACE, ADMIN_SURFACE}),
    ),
    OperationSpec(
        op_name="skill_proposal_list",
        tool_name="memory_skill_proposal_list",
        method_name="memory_skill_proposal_list",
        description="List visible skill pack proposal records.",
        roles=("proposer",),
        discovery_surfaces=frozenset({STANDARD_SURFACE, CURATOR_SURFACE, ADMIN_SURFACE}),
    ),
    OperationSpec(
        op_name="skill_proposal_review",
        tool_name="memory_skill_proposal_review",
        method_name="memory_skill_proposal_review",
        description="Review a skill pack proposal as curator.",
        roles=("curator",),
        discovery_surfaces=frozenset({STANDARD_SURFACE, CURATOR_SURFACE, ADMIN_SURFACE}),
    ),
    OperationSpec(
        op_name="skill_proposal_apply",
        tool_name="memory_skill_proposal_apply",
        method_name="memory_skill_proposal_apply",
        description="Apply an approved skill pack proposal through the Git transaction pipeline.",
        roles=("curator",),
        discovery_surfaces=frozenset({STANDARD_SURFACE, CURATOR_SURFACE, ADMIN_SURFACE}),
        commit_capable=True,
    ),
