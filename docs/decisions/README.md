...
| [0009](0009-run-gte-in-batched-short-lived-workers.md) | Run GTE in mmap-backed short-lived workers; DiskStation uses progressive single-item scheduling | accepted, amended |
