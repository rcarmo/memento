...
Evidence for that historical run is retained in [`../evidence/go-python-models-off-benchmark-2026-09-19.json`](../evidence/go-python-models-off-benchmark-2026-09-19.json). The pure-Go branch no longer carries the Python comparison harness; current allocation and model performance gates run through `make performance`.
