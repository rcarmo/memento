...
Evidence captured under `/workspace/tmp/memento-link-audit/`; repeatable tests are checked into `internal/graphdebug/` and `tools/browser/`. [Production v1.0.6 validation](release-1.0.6.md) completed after exact-commit CI, release, a verified backup and state-copy canary.
