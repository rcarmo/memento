...
func (j *Jobs) runWithPolicy(ctx context.Context, principal access.Principal, session *string, method string, resolve bool, call JobCall, open func(context.Context, string) (*sql.DB, error)) (any, error) {
	...
	if method == "memory_inventory" || method == "memory_asset_get" || method == "memory_operation_get" || method == "memory_proposal_asset_get" || method == "memory_read" || method == "memory_list" || method == "memory_search" || method == "memory_graph" {
		err = run()
	} else {
